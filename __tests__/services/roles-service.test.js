...
import RolesService from "../../src/repositories/role-service.js";
...
describe("Role service", () => {
  ...
  describe("create", () => {
    it("should create a new role", async () => {
      const role = await service.create(roleData);
  ...
  describe("find by Id", () => {
    it("should find a role by id", async () => {
      await service.create(roleData);
      const foundRole = await service.getById(id);
  ...
  describe("getMaxRole", () => {
    it("should return the role with the most employees asigned", async () => {
      const maxRole = await service.getMaxRole(roleData);
